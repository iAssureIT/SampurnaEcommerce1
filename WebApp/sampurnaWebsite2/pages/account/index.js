                    ...
                    <div className={"col-5 mx-auto NoPadding "+Style.modalMainWrapper}>
                        ...
                        <div className={"modal-header globalBgColor col-12 " +Style.modalHeaderM}>
                            <div className={"modal-title col-12 modalheadingcont pb-3  underline " +Style.f14BM }>
                                {/* <img className={" "+Style.modalLogoWrapperM} src="/images/eCommerce/KokilaEducationLogo.png" alt="T&C MODAL-LOGO"/> */}
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 mt-3 ">
                                        ...
                                        <div className="col-5 py-4 float-right">
                                            <button className={"btn globalCommonBtn mx-5 col-12 col-sm-7 "+Style.globalCommonBtn} id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i className="fa fa-pencil-square-o"></i> &nbsp; EDIT</button> &nbsp; &nbsp; </div>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div className={ "box "+Style.box}> {/*
                                    ...
                                    <div className="col-12 ">
                                        ...
                                        <div className="col-12">
                                                ...
                                                <div data-toggle="modal" data-target="#checkoutAddressModal" onClick={this.getAddressId.bind(this)} id={this.state.deliveryAddressID} className={"btn globalCommonBtn float-right "+Style.globalCommonBtn}><i className="fa fa-pencil-square-o"></i> &nbsp; EDIT ADDRESS</div>
                                    ...
                                    <div className="col-12 ">
                                        ...
                                        <div className="col-12 ">
                                            <button data-toggle="modal" data-target="#checkoutAddressModal" className={"btn globalCommonBtn col-12 col-sm-7 float-right "+Style.globalCommonBtn}><i className="fa fa-pencil-square-o"></i> &nbsp; ADD ADDRESS</button>
                                        </div>
                                    </div> } </div>
                            </div>
                            <div className="col-12 col-lg-6">
