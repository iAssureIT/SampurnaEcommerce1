...
import OrderStatusWizard    from '../../Themes/Bookstore/blocks/StaticBlocks/Wizard/OrderStatusWizard.js';
               ...
               <div className="row"> 
                <div className="col-12 col-12 col-md-12">
                  ...
                  <div className={"col-12 NoPadding orderDetailsTopBlock"}>
                    <div className={"col-12 NoPadding orderDetailsTop "+Style.orderDetailsTop}>
                      <div className={"row " +Style.ptb15}>
                        ...
                        <div className={"col-6 " +Style.rightside}>
                            <div className="row">
                                ...
                                <br/>
                                <div className="col-12">
                                  <div className="col-12"><button class="hide-on-print" onClick={this.printReceipt}>Print</button></div>
                                </div>
                            </div>
                          </div>    
