...
import Address              from '../../Themes/Bookstore/blocks/StaticBlocks/Address/Address.js';
import BreadCrumbs          from '../../Themes/Bookstore/blocks/StaticBlocks/BreadCrumbs/BreadCrumbs.js';
import ReturnStatus         from '../../Themes/Bookstore/blocks/StaticBlocks/Wizard/ReturnStatus.jsx';
import StepWizard           from '../../Themes/Bookstore/blocks/StaticBlocks/Wizard/StepWizard.jsx';
                ...
                <h4 className="table-caption">My Orders</h4>
                  {
                    this.state.orderData && this.state.orderData.vendorOrders && this.state.orderData.vendorOrders.length > 0 ?                    
                      this.state.orderData.vendorOrders.map((data, index) => {
                        ...
                        return (
                          ...
                          <div key={index} style={{marginBottom:"40px"}} className={"row"}>
