                      ...
                      this.state.orderData.map((singleOrder, index) => {
                        ...
                        return(
                          <div className={"col-12 NoPadding orderIdborder " +Style.orderIdborderNew} key={index}>
                            <div className={"col-12  NoPadding orderNowrapper mb-4 "+Style.orderNowrapper}>
                              ...
                              <div className={"col-12 " +Style.vendorRowBottom}> 
                                    ...
                                    <div className="col-7  pull-right orderBtnWrapper">
                                      <button className=" btn col-6 float-right " onClick={()=>this.props.getOrderId(singleOrder._id)}>
                                        <a id="v-pills-settings2-tab" data-toggle="pill" href="#v-pills-settings2" role="tab" aria-controls="v-pills-settings2" aria-selected="false" className={"col-9 float-right showDetailsBtn "+Style.showDetailsBtn} >Show Details</a>
                                      </button>
                                    </div>
                                  </div>
                              </div>
