                            ...
                            <div className="col-12 col-lg-6 py-4">
                                <div className="col-12"> { this.state.addressLine1 ?
                                    <div className="row">
                                        ...
                                        <div data-toggle="modal" data-target="#checkoutAddressModal" id={this.state.deliveryAddressID} onClick={this.getAddressId.bind(this)} className={"btn globalCommonBtn "+Style.globalCommonBtn}>Change Billing Address</div> {/* <i id={this.state.deliveryAddressID} onClick={this.deleteAddress.bind(this)} className="fa fa-trash btn anasBtn deleteAdd"></i> */} </div> :
                                    <div className="col-12">
                                        <label className={Style.defaultAddress}>Default Billing Address</label>
                                        <p>You have not set a default billing address.</p>
                                        <div data-toggle="modal" data-target="#checkoutAddressModal" className={"btn globalCommonBtn mt-2 "+Style.globalCommonBtn}>Add Billing Address</div>
                                    </div> } </div>
                            </div>
                            <div className="col-12 NOpaddingRight ">
                            <label className={Style.additionalAddress}>Additional Address Entries</label>
                                <div className="row">
                                ...
                                <p className="text-justify ml-5">You have no other address entries in your address book.</p> }
                                <div className="col-12 NOpadding py-4">
                                    <div data-toggle="modal" data-target="#checkoutAddressModal" id="" className={"btn globalCommonBtn addressSaveBtn "+Style.globalCommonBtn+" "+Style.addressSaveBtn }>Add New Address</div>
                                </div>
                            </div>
