...
import Header               from '../../Themes/Bookstore/blocks/5_HeaderBlocks/SampurnaHeader/Header.js';
import Footer               from '../../Themes/Bookstore/blocks/6_FooterBlocks/Footer/Footer.js';
import Message              from '../../Themes/Bookstore/blocks/StaticBlocks/Message/Message.js'
import SmallBanner          from '../../Themes/Bookstore/blocks/StaticBlocks/SmallBanner/SmallBanner.js';
import Loader               from '../../Themes/Bookstore/blocks/StaticBlocks/loader/Loader.js';
import Sidebar              from '../../Themes/Bookstore/blocks/StaticBlocks/Sidebar/Sidebar.js';
                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12 col-12 ">
                                ...
                                <div className={"nav flex-column nav-pills nav-pills-custom navPillsWrapper "+S.navPillsWrapper} id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a className={"nav-link mb-4 p-3 shadow "+S.myAccountPills} id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                                        <i className="fa fa-address-card mr-3"></i>
                                        <span className=" small text-uppercase">Address Book</span></a>
                
                                    <a className={this.state.url1==="#v-pills-settings-tab" ? "nav-link mb-4 p-3 shadow active "+S.myAccountPills : "nav-link mb-4 p-3 shadow "+S.myAccountPills} id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                        <i className=" fa fa-shopping-cart mr-3"></i>
                                        <span className=" small text-uppercase" > My Orders</span></a>

                                    <a className={this.state.url1==="#v-pills-settings1-tab" ? "nav-link mb-4 p-3 shadow active "+S.myAccountPills : "nav-link mb-4 p-3 shadow "+S.myAccountPills} id="v-pills-settings1-tab" data-toggle="pill" href="#v-pills-settings1" role="tab" aria-controls="v-pills-settings1" aria-selected="false">
                                    <i className="fa fa-heart mr-3"></i>
                                    <span className=" small text-uppercase"> My Wishlist</span></a>

                                    {/* <a className={this.state.url1==="#v-pills-settings3-tab" ? "nav-link mb-4 p-3 shadow active "+S.myAccountPills : "nav-link mb-4 p-3 shadow "+S.myAccountPills} id="v-pills-settings3-tab" data-toggle="pill" href="#v-pills-settings3" role="tab" aria-controls="v-pills-settings3" aria-selected="false">
