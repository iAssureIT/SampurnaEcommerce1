...
export default class Footer extends Component {
    ...
    render(){
       return(
        ...
        <div className={"col-12 footerNew "+S.footerNew}>
            <div className="col-12 col-xl-6 offset-xl-6 col-lg-6 offset-lg-6">
                <div className="col-12 textEnd "><i class={"fas fa-phone-alt fIcon "+S.fIcon}></i><span className={"phoneT "+S.phoneT}>Phone &nbsp;&nbsp;:&nbsp;&nbsp;</span>  +91 18000 00000 &nbsp;&nbsp;&nbsp;&nbsp; <i class={"fas fa-envelope fIcon "+S.fIcon}></i><span className={"phoneT "+S.phoneT}>Mail Us &nbsp;&nbsp;:&nbsp;&nbsp; </span> kokilaeducation@gmail.com</div>
            </div>
        </div>
       ...
       <div className="container-fluid">
        ...
        :null}
        <div className={"footer3 col-12 "+S.footer3}>
            <div className={"col-12 footer_bottom "+S.footer_bottom}>
              <div className={"row " +S.footerBottom}>
              <div className={"col-12 col-sm-12 col-xl-3 col-lg-3 col-md-12 col-sx-12 " +S.logoTop}>
                 <img src="/images/eCommerce/KokilaEducationLogo.png" className="" alt="FooterLogo" width="" height="75px"/>
              </div>
              ...
              <div className={"col-12 col-sx-12 col-xl-6 col-lg-6 col-md-12 text_Center mx-0 " }>
                <div className={"col-12 col-sm-12 col-lg-12 col-md-12 text_Center mt-3 mb-3 " +S.icon}>
                    <div className="socialMediaIcons"><Link href="https://www.instagram.com/kokilaeducation" passHref={true}><a  target="_blank"><i className="fab fa-instagram mt15 ml0" aria-hidden="true"></i></a></Link></div>                
                    <div className="socialMediaIcons"><Link href="https://www.facebook.com/kokilaeducation" passHref={true}><a  target="_blank"><i className="fab fa-facebook-f mt15"></i></a></Link></div>                        
                    ...
                    <div className="socialMediaIcons"><Link href="https://www.twitter.com/kokilaeducation" passHref={true}><a  target="_blank"><i className="fab fa-twitter mt15" aria-hidden="true"></i></a></Link></div>                    
                </div> 
                <div className="col-12 col-sx-12 col-xl-12 col-lg-12 col-md-12 text_Center">
                    <div className={"col-12 text-center footer3Class " +S.aboutHeight}>
                      ...
                      <div className={"col-12 text-center footer3Class "+S.footer3Class}>
                          Conditions of Use & Sale &nbsp;&nbsp;&nbsp;&nbsp; Privacy Notice &nbsp;&nbsp;&nbsp;&nbsp; Interest-Based Ads
                      </div>
                      <div className="col-12 text-center">
                        <p className={"footer3Class "+S.footer3Class}><i className={"fa fa-copyright footer3Class "+S.faCopyright}></i> 2021 | KokilaEducation.com</p>
                      </div>                      
                  </div>
              </div>
