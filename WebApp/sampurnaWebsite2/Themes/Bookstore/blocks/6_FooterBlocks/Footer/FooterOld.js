            ...
            <div className="col-xl-3 col-md-2 col-sm-6  col-12 onlineShoppingWrapper">               
                ...
                <div className="col-12">
                    ...
                    <div className="col-12 col-sm-6 col-lg-12 col-md-12  NoPadding">
                        <div className="socialMediaIcons pull-right"><Link href="https://www.facebook.com/kokilaeducation"><a  target="_blank"><i className="fab fa-facebook-f"></i></a></Link></div>
                        <div className="socialMediaIcons pull-right"><Link href="https://www.instagram.com/kokilaeducation"><a  target="_blank"><i className="fab fa-instagram" aria-hidden="true"></i></a></Link></div>
                        ...
                        <div className="socialMediaIcons pull-right"><Link href="https://twitter.com/kokilaeducation"><a  target="_blank"><i className="fab fa-twitter" aria-hidden="true"></i></a></Link></div>                   
                    </div>
                </div>
            </div>
           </div>             
