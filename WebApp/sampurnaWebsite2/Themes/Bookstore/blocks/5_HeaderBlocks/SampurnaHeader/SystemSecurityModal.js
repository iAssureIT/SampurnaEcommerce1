                    ...
                    <li className="dropdown myaccDropdown">
                        <span className="col-12 NoPadding ">
                            <div className="faIcon faLoginIcon col-12 mt-2 NoPadding"> 
                                <div className={"mtm10 "+Style.systemSecurityModalWrapper+" "+S.systemSecurityModalWrapper}>  
                                    {this.state.authService === "guest" && this.state.userId ?
                                        <span className="my-auto">
                                            <span style={{float: "right"}} className="faIcon col-12 NoPadding pb-1"><span className={"userName "+S.userName}>Hello Guest!</span></span>
                                            <span className={"userEmail "+S.userEmail}>My Account <i className="fa fa-angle-down"></i></span>
                                        </span>
                                    :
                                    <span className="my-auto">
                                        <span style={{float: "right"}} className="faIcon col-12 NoPadding pb-1"><span className={"userName "+S.userName}>Hello&nbsp; {this.state.userName}!</span></span>
                                        <span className={"userEmail "+S.userEmail}>My Account <i className="fa fa-angle-down"></i></span>
                                    </span>
                                    }
                                </div>
                        ...
                        {this.state.authService!=="guest"?    
                            <div className="col-12 NoPadding">                                 
                                ...
                                <li className={"col-12 NOpadding myAccMenu globalSignoutBtn signoutBtn outBTN "+S.signoutBtn}  onClick={this.signOut.bind(this)}><Link href="/"><a style={{color:"#fff"}}>Sign Out</a></Link></li>
                            </div>
                        :
                            <div className="col-12 NoPadding">
                                <li className="col-12 NOpadding myAccMenuGuest text-center"><Link href="/my-account#v-pills-settings-tab"><a>My Orders</a></Link></li>
                                <li className={"col-12 NOpadding myAccMenu globalSignoutBtn signoutBtn outBTN "+S.signoutBtn} data-toggle="modal" data-target="#loginFormModal" data-backdrop="true" id="loginModal" area-hidden ="true">Sign In</li>
                            </div>
                        }
                            </ul>
                    </li>
                            ...
                            <div className="modal-body LoginModalBody">  
                                ...
                                <div className="row"> 
                                    <div className="col-7 NoPadding pb-4 modalImgBlock">
                                        ...
                                        <div className={"modal-title col-12 pt-5 modalheadingcont pb-2 text-center underline " +Style.f14B }><img className={" "+Style.modalLogoWrapper} src="/images/eCommerce/KokilaEducationLogo.png" height="54px" alt="T&C MODAL-LOGO"/></div>
                                        </div>
