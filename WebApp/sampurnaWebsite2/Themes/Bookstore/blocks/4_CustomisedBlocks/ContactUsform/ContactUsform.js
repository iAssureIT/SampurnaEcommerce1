...
export default class CUform extends React.Component {
    ...
    this.state = {
	    ...
	    blocks: {
			...
			"blockEmail"          : "admin@kokilaeducation.com",
	        "repeatedBlocks" 		  : [
										...
										},
										{
								        	Title :"Call Us:",
											Image :"/images/loader.gif",
											blockSubTitle  : "admin@kokilaeducation.com",
...
componentDidMount(){
                ...
                .then((response)=>{
                    ...
                    if(response.data){
                      ...
                      this.setState({
						  ...
						  blockEmail  : response.data.blockContact ? response.data.blockContact : "admin@kokilaeducation.com"
	...
	Submit(event){
	    ...
	    var adminEmail = "admin@kokilaeducation.com";
