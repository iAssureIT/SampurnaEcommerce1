...
class VendorList extends Component {
    ...
    render() {
        var bgImgHeight   = this.state.vendorList.length * 82;
        var vendorListTop =  parseInt("-"+this.state.vendorList.length * 82);
        return(
            <div className={"col-12 " +Style.bgGray}>
                <div className="row">
                <Header /> 
                    <div className={"col-12 " +Style.bgHeight} style={{ height: bgImgHeight }}></div>      
                      
                    <div className={"col-12 NoPadding "+Style.vendorList} style={{"top":vendorListTop}}>
