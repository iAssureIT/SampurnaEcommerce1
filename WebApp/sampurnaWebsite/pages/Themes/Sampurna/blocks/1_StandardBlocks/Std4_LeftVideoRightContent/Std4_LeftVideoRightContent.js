...
import S                        from './Std4_LeftVideoRightContent.module.css';


export default class Std4_LeftVideoRightContent extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            blocks : {
                ...
                "blockComponentName" : "Std4_LeftVideoRightContent",
				"blockTitle"         : "Standard 4 - Left Video Right Content",
                "blockSubTitle"      : "",
                ...
                "fgImage2"           : "",
                "bgImage"            : "",
				"fgVideo"			 : "/images/CMSImages/BlockFGVideo.mp4",
				"bgVideo"			 : "",
                "repeatedBlocks": [
                    {
                        Title        : "",
                    ...
                    ?
                        <section className="col-12 stdBlockWrapperBackground" style={{backgroundImage:"url("+this.state.blocks.bgImage+")"}}>
                            ...
                            <div className="col-12 stdBlockContentWrapper">
                                <div className="row">
                                    <div className="col-12 col-lg-6 stdBlockVideoWrapper">
                                        <div className="col-12">
                                            <video className="mt-lg-5 mt-xl-0 stdBlockFGVideo" width="300" controls><source src={this.state.blocks.fgVideo} type="video/mp4" /></video>
                                        </div>
                                    </div>
