            ...
            <div className="pagealertnone col-lg-12 col-md-12 col-sm-12">
              <Message messageData={this.state.messageData} />
                ...
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NoPadding">
                    <br/>
                    <div className="col-lg-3 col-md-3 col-sm-4 col-xs-12 NOpadding mr20">
                        <Sidebar />
                    </div>
                    <div className="col-lg-8 col-md-8 col-sm-7 col-xs-12 NOpadding mt25">
                        ...
                        
                        {
                            ...
                            this.state.deliveryAddresses.map((address , index)=>{
                                if(index !== 0){
                                    return(
                                        <div key={'address'+index} className="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb15 NOpaddingLeft addressHeight">
                                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                <div className="row">
                                                    <p>
                                                        {address.name} <br />
