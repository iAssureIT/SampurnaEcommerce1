            ...
            <div className={"col-xl-10 offset-xl-1 col-md-10 offset-md-1 col-sm-12 col-xs-12 col-12  mt-5 m-b-5 "+Style.paymentMainWrapper}>
              <div className="row">
                ...
                <div className={"mx-4 "+Style.paymentAlertWrapper}>
                  <h6>Receipt From
                  <h6 className="mx-4 mt-2">Trollymart</h6></h6>
                </div>
                <div className={"mx-4 mt-4 "+Style.paymentLockWrapper}>
                  <i className="fa fa-lock"></i>&nbsp;&nbsp;Amount <br/>
                </div>
                <div className={"mx-4 mt-4 "+Style.paymentLockWrapper}>
                  <i className="fa fa-calendar"></i>&nbsp;&nbsp;Date <br/>
                  <p className="mt-2 mx-3">{moment(this.state.orderData.createdAt).format("DD MMMM")}  | OrderID -  {this.state.orderData.orderID}    {this.state.orderData.shippingtime?<span className="pull-right hidden-xs">Shipping Time : {this.state.orderData.shippingtime}</span>:null}</p>
