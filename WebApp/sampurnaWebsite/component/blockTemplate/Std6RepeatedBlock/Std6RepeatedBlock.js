...
import "./Std6RepeatedBlock.module.css";
						...
						this.state.blocks.repeatedBlocks.map((data, index)=>{
                					return(
											<div key={index} className="col-lg-4 col-md-4 col-sm-12 col-xs-12">
												<img loading="lazy" src={data.Image} alt="enteprice" className="lazyload col-lg-12 col-md-12  col-sm-12 col-xs-12 " height="200px" /> 
