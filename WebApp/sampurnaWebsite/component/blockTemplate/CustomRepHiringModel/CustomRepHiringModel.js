...
import "./CustomRepHiringModel.module.css";
						...
						<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
							...
							<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 nopadding RepboxT1 RepboxT1Active">
								<div className="col-lg-12 col-md-12  col-sm-12 col-xs-12"> 
									<div className="col-lg-12 col-md-12  col-sm-12 col-xs-12">
									<div className="col-lg-12 col-md-12  col-sm-12 col-xs-12 iconCircleCRHM">
									   <img src={this.state.blocks.repeatedBlocks[1] ? this.state.blocks.repeatedBlocks[1].Image : "https://unimandai.s3.amazonaws.com/CMS/Photos-new-icon_2020101519113.png"} alt="enteprice" className="innerCircleCRHM img-responsive" /> 
								    </div> 
								    </div> 
									<div className="sptextBox1CRHM col-lg-12 col-md-12  col-sm-12 col-xs-12">
							...
							<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 nopadding RepboxT1 RepboxT2BxShadow">
								<div className="col-lg-12 col-md-12  col-sm-12 col-xs-12"> 
									<div className="col-lg-12 col-md-12  col-sm-12 col-xs-12">
									<div className="col-lg-12 col-md-12  col-sm-12 col-xs-12 iconCircleCRHM">
