...
export default class ContactUs extends Component{
	...
	render(){
		...
		return(
			<section className={ "col-12 pt-4 y "+S.y}>
				<div className="row">
					<div className={ "col-lg-12  x "+S.x} style={{backgroundImage: "url("+this.state.blocks.bgImage+ ")"}}></div>
					<div className={ "col-lg-8 offset-lg-2 z "+S.z}>
						<div className="row">
							<div className={ "col-lg-8 mb-4 mb-lg-0 p "+S.p}>
								<div className="row"> {/*
									<div className="col-lg-10 offset-lg-1 mt-5 pt-5" id="ContactUs"> */}
										<form className={ "col-lg-10 offset-lg-1 mt-5 pt-5 "+S.conatctform} id="ContactUs">
											<div class="form-group">
												<label for="name" className={ "control-label k "+S.k}>Your Name</label>
												<input className={ "form-control c "+S.c} for="name" name="name" type="text" id="name" ref="name" required value={this.state.name} onChange={this.handleChange.bind(this)} /> </div>
											<div class="form-group mt-5">
												<label for="name" className={ "control-label k "+S.k}>Email</label>
												<input className={ "form-control c "+S.c} for="email" name="email" type="email" id="email" data-text="clientEmail" ref="email" required value={this.state.email} onChange={this.handleChange.bind(this)} /> </div>
											<div class="form-group mt-5">
												<label for="name" className={ "control-label k "+S.k}>Phone</label>
												<input className={ "form-control c "+S.c} for="mobile" type="number" name="mobile" id="mobile" ref="mobile" required value={this.state.mobile} value={this.state.mobile} onChange={this.handleChange.bind(this)} /> </div>
											<div class="form-group mt-5">
												<label for="name" className={ "control-label k "+S.k}>How we can help you?</label>
												<input className={ "form-control c "+S.c} for="message" name="message" id="message" rows="4" ref="message" required value={this.state.message} onChange={this.handleChange.bind(this)} /> </div>
											<div className={ "col-lg-12 pb-lg-5 pb-0 "}>
												<button type="button" className={ "btn btn-default pull-right getInTouchBtnWrapper "+S.getInTouchBtnWrapper} id="myBtn" value=" Send " onClick={this.Submit.bind(this)}>Send&nbsp;<i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
											</div>
										</form> {/* </div> */} </div>
							</div>
							<div className={ "col-lg-4  mt-5 mt-lg-0 q "+S.q}>
								...
								<div className={ "hero "+S.hero}>
									<div className={ "social_links col-lg-12 pt-lg-4 pt-4 "+S.social_links}> <a href=""><i class="fa fa-instagram"></i></a> <a href=""><i class="fa fa-facebook-f"></i></a> <a href=""><i class="fa fa-youtube"></i></a> <a href=""><i class="fa fa-linkedin"></i></a> <a href=""><i class="fa fa-twitter"></i></a> </div>
								</div>
							</div>
						</div>
					</div>
