...
constructor(props) {
	...
	render() {
		return (
			<div className={"container-fluid ourPortFolioWrapper "+Style.ourPortFolioWrapper}>
				<div className="row">
				...
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12" style={{backgroundImage:"url("+this.state.blocks.bgImage+")"}}>
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div className={"col-lg-10 col-lg-offset-1 col-md-10 col-sm-12 col-xs-12 ourPortfolioTitle "+Style.ourPortfolioTitle}> 
                            	<h1 className="text-center"><b>{this.state.blocks.blockTitle}</b></h1>	
                            </div>

                        </div>
                    </div> 
                    <div className={"col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12 buttonWrapper "+Style.buttonWrapper}>
				     	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">	
						 {
						...
						this.state.blocks.repeatedBlocks.map((data, index)=>{
							var i= index+1;
                					return(
						  	<button type="button" className={"btn btn-default link "+i+" "+Style.btn}>{data.Title}</button>
							  );
							})
						:	
						null
                    ...
                    </div> 
					{
						...
						this.state.blocks.repeatedBlocks.map((data, index)=>{
							...
							console.log("dataImages",data.Images)
                					return(
										<div className={" x col-lg-10 col-lg-offset-1 col-md-12 col-sm-12 col-xs-12 link "+i+"Div"+" "+Style.x}>
											<div className={"col-lg-12 col-md-12 col-sm-12 col-xs-12 y "+Style.y}>
												
													{data.Images.length>0 ? data.Images.map((image,ind)=>{
                                                     return(
														<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 x ">
														<div className={"col-lg-12 col-md-12  col-sm-12 col-xs-12 innerBoxPortFoilio "+Style.innerBoxPortFoilio}> 
