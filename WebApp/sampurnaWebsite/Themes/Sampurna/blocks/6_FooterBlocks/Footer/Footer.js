       ...
       <div className="container-fluid">
        ...
        <div className="container-flex">
            <div className="col-12 footer_bottom">
              ...
              <div className={"col-12 col-sm-6 mx-auto col-xl-3 col-lg-3 col-md-12 col-sx-12 " +S.logoTop}>
              ...
              <div className={"col-12 col-sx-12 col-xl-6 col-lg-6 col-md-12 text_Center mx-0 " }>
                <div className={"col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-6 offset-sm-3 col-10 offset-1 text_Center mt-3 mb-3 " +S.icon}>
