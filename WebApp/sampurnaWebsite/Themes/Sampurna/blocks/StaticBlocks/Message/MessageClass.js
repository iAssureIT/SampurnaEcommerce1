...
class Message extends Component{
    ...
    //     console.log("messagedata prevProps ==========> ",prevProps);
    //     if(this.props && this.props.messageData !== undefined){
    //         this.setState({
    //             "alertType"   : this.props.messageData.type ? this.props.messageData.type : '',
    //             "class"       : this.props.messageData.class ? this.props.messageData.class :'',
    //             "icon"        : this.props.messageData.icon ? this.props.messageData.icon :'',
    //             "message"     : this.props.messageData.message ? this.props.messageData.message :'',
    //             "autoDismiss" : this.props.messageData.autoDismiss ? this.props.messageData.autoDismiss : '',
    //         })
            
    //         if(this.props.messageData.autoDismiss && this.props.messageData.autoDismiss === true){
    //             setTimeout(() => {
    //                 this.setState({
    //                     alertType   : "",
    //                     class       : "",
    ...
    render(){
        ...
        return(
            ...
            {/*
                ...
                ?
                    <div className={"alert alert-"+this.state.class} role="alert">
                        <div className={this.state.icon+" inpagemessage"}>{this.state.message}</div>
                    </div>
                :
            ...
            */}
            {
                this.props.messageData && this.props.messageData.alertType && this.props.messageData.alertType === 'inpage' 
                ?
                ...
                :
                    this.props.messageData && this.props.messageData.alertType && this.props.messageData.alertType === 'outpage' 
                    ?
                        <div className="row ml-auto pull-right outpageMessage">
                            <div className="alert-group">
                                <div className={"alert alert-"+this.props.messageData.class+" alert-dismissable " +Style.alertMessage}>
                                    <button type="button" className="close" onClick={this.close.bind(this)}>×</button>                                    
                                    <div className={this.props.messageData.icon+" inpagemessage"} >{this.props.messageData.message}</div>
                                </div>
                            </div>
                        </div>
                    :
