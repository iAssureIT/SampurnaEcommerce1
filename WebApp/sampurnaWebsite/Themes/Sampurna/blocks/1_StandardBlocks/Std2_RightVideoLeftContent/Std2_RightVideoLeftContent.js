...
import S                        from './Std2_RightVideoLeftContent.module.css';


export default class Std2_RightVideoLeftContent extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            blocks : {
                ...
                "blockComponentName" : "Std2_RightVideoLeftContent",
				"blockTitle"         : "Standard 2 - Right Video Left Content",
                "blockSubTitle"      : "",
                            ...
                            <div className="col-12 stdBlockContentWrapper">
                                <div className="row">
                                    ...
                                    <div className="col-12 col-lg-6 stdBlockVideoWrapper">
                                        <div className="col-12">
                                            <video className="mt-5 mt-xl-0 stdBlockFGVideo" width="300" controls><source src={this.state.blocks.fgVideo} type="video/mp4" /></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
