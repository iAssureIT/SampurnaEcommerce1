          ...
          <div className="row ml-auto pull-right outpageMessage"
           ...
           { Array.isArray(this.props.newProducts) && this.props.newProducts.length > 0 ?
            Array.isArray(this.props.newProducts) && this.props.newProducts.map((data, index) => { 
              ...
              return (
                <div className={" col-sm-12 offset-sm-0 col-10 offset-1 col-lg-4 offset-lg-0 col-md-4 offset-md-0 col-xl-3 offset-xl-0  " +Style.mobileViewPadding +" "+Style.productWrapper}   key={index}> 
                      ...
                      <div className={Style.productDetails +" " +"col-12 NoPadding " +Style.NoPadding}>                             
                        <div className={"col-12 " +Style.innerDiv}>
                          ...
                          <div className={"col-12 NoPadding " +Style.NoPadding}>
                            <div className={"col-12 NoPadding " +Style.NoPadding + " " + Style.addcartBtnWraper}>                                  
                              { 
