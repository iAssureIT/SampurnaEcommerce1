                    ...
                    <div className="">
                        ...
                        <div className="col-12">
                            <div className="row">
                                ...
                                <div className={"col-12 col-lg-12 "+ Style.mainMenuWrapper}>
                                    <div className="row h-100">
                                        <div className="col-12 navbar-header">
                                        <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                                            <span className="navbar-toggler-icon"></span>
                                        </button>                             
                                        </div>
                                        <div id="collapsibleNavbar" className={"collapse navbar-collapse " + Style.mainMenu}>
                                            <div className="col-12 h-100">
                                                <div className="row h-100">
                                                <div className={"col-2 " + Style.allCategories}>
                                                    All Categories
                                                </div>
