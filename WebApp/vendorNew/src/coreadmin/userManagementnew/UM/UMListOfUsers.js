...
class UMListOfUsers extends Component {
	...
	render() {
		...
		// console.log("this.state.twoLevelHeader  ==> ",this.state.twoLevelHeader)
		// console.log("this.state.tableHeading  ==> ",this.state.tableHeading)
		return (
									...
									<div className="modal-bodyuser">
										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div className="col-lg-2 col-md-3 col-sm-12 col-xs-12 " id="createmodalcl">
												<button type="button" className="btn col-lg-12 col-md-12 col-sm-12 col-xs-12 addexamform addexamform clickforhideshow" data-toggle="modal" data-target="#CreateUserModal" onClick={this.CreateUserModal.bind(this)} ><i className="fa fa-plus" aria-hidden="true"></i><b>&nbsp;&nbsp;&nbsp; Add User</b></button>
											...
											<div className="col-lg-2 col-md-3 col-sm-12 col-xs-12 " id="rolemodalcl">
												<button type="button" className="btn col-lg-12 col-md-12 col-sm-12 col-xs-12 addexamform addexamform clickforhideshow"
...
// 										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
// 											<div className="col-lg-2 col-md-3 col-sm-12 col-xs-12 " id="createmodalcl">
// 												<button type="button" className="btn col-lg-12 col-md-12 col-sm-12 col-xs-12 addexamform addexamform clickforhideshow" data-toggle="modal" data-target="#CreateUserModal"><i className="fa fa-plus" aria-hidden="true"></i><b>&nbsp;&nbsp;&nbsp; Add User</b></button>
// 												{this.state.companyID > 0
// 													?
// 													<CreateUser
// 														companyID={this.state.companyID}
...
// 											</div>
// 											<div className="col-lg-2 col-lg-offset-6 col-md-3 col-sm-12 col-xs-12 ">
// 												<button type="button" className="btn col-lg-12 col-md-12 col-sm-12 col-xs-12 btn-danger addexamform"
// 													onClick={this.redirectToDeleteUsers.bind(this)}>
// 													<i className="fa fa-minus" aria-hidden="true"></i>
// 													<b>&nbsp;&nbsp;&nbsp; Deleted Users</b>
// 												</button>
