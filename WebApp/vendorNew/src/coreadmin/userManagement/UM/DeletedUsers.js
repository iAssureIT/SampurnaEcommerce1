					...
					if (res.data.message == "COMPANYID_NOT_AVAILABLE") {
						...
						var tableData = tableData.map((a, i) => {
							...
							return {
								...
								'<p><i class="fa fa-envelope"></i> ' + a.email + '&nbsp  | &nbsp'+ a.mobNumber ? '<i class="fs16 fa fa-mobile"></i> ' + a.mobNumber + '</p>': 'NA',
							...
							<div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 pageContent ">
								<div className="row">
									<div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 titleaddcontact">
										...
										<div className="col-lg-2 col-md-2 col-sm-12 col-xs-12 paddingTop5" id="rolemodalcl">
												<button type="button" className=" col-lg-12 col-md-12 col-sm-12 col-xs-12 addexamform  userbtndelete clickforhideshow"
