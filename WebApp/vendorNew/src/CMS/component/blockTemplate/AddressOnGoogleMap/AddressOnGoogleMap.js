...
export default class AddressOnGoogleMap extends React.Component {
	...
	render(){
		return(
			<div className="container-fluid mapWrapper gmapwrapper">
				<div className="row">
					<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mapTitleWrapper Glocationmap">
						<h1 className="location" dangerouslySetInnerHTML={ { __html:this.state.blocks.blockTitle}}></h1>
					</div>
