				...
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12" >				   
					<div className="StaffBannerwrapp" style={{backgroundImage:"url("+this.state.blocks.bgImage+")"}}>
						<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
							<div className="col-lg-9 col-lg-offset-3  col-md-9 col-md-offset-3 col-sm-12 col-xs-12 staffBannerLeft">
						...
						<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopadding">
							<div className="col-lg-6 col-lg-offset-3 col-md-6 col-sm-12 col-xs-12 nopadding ReqForm">
								...
								<form className="formWrapper">
									<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 formWrapperTitle">
									...
									<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mtop10">
											...
											<i className="fa fa-lock"></i>
								        		<textarea  className="form-control InputBoxCustom "rows="3" cols="50" name="message" placeholder="Project Brief"
										...
										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
											<button className="btn btn-default col-lg-12  marginLeft23" onClick={this.handleSubmit.bind(this)}>Sign Up</button>
										</div>
									</div>
								</form>
							</div>
