...
class ProductList extends Component {
    ...
    productCountByStatus(){
        var vendorID = JSON.parse(localStorage.getItem("userDetails")).company_id;
        axios.get('/api/products/get/vendorProductCount/'+vendorID)
            .then((response) => {
    ...
    getData(startRange, limitRange) {
        ...
        var data = {
            startRange: startRange,
            limitRange: limitRange,
            vendor_ID : JSON.parse(localStorage.getItem("userDetails")).company_id
        }
        this.getCount();
    ...
    getSearchText(searchText) {
        ...
        var vendorID = JSON.parse(localStorage.getItem("userDetails")).company_id; 
        axios.get("/api/products/get/search/" + searchText + "/"+ vendorID )
            .then((response) => {
                this.setState({
    ...
    handleChangeFilter(event){
        ...
        // if (currentSelection === 'vendorChange') {
            selector.vendorIds = [JSON.parse(localStorage.getItem("userDetails")).company_id];
        // }
        if (currentSelection === 'sectionChange') {
            selector.sectionIds = event.value;
        }
        ...
        return (
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOPadding">
                <div className="row">
                    ...
                    <div className="modal mgleft" id="bulkActionModal" role="dialog">
