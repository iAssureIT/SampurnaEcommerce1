...
class OrderStatusBulkUpload extends Component { 
  constructor(props) {
    super(props);
    this.state = {
      "fields" : {
  ...
  submitPerson(event) {
    ...
    if ($('#BasicInfo').valid()) {
        ...
        var userDetails = {
         ...
         axios.post('/api/orderStatus/post', userDetails)
          .then((response) => {
  ...
  edit() {
    ...
    if (personID) {
      axios.get('/api/orderStatus/get/one/' + personID)
        .then((response) => {
            ...
            <section className="content">
              <div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div className="box-header with-border col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding-right">
                  <h4 className="col-lg-9 col-md-6 col-xs-6 col-sm-6 NOpadding-right weighttitle">{"Add  "+this.state.pathname}</h4>
...
export default OrderStatusBulkUpload;