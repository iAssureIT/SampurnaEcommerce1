...
class OrderRejectReasons extends Component {
	constructor(props) {
		super(props);
		this.state = {			
			fields 				: {
				placeholder     : "Enter reason of order reject.",
				title           : "Reason of Order Reject for Delivery Person",
				attributeName   : "reasonOfOrderReject"
			},
			tableHeading		: {
				reasonOfOrderReject : "Reason's of Order Reject",
				actions 			: 'Action',
			},
			tableObjects 		: {
				deleteMethod 	: 'delete',
				apiLink 		: '/api/orderrejectreasons/',
			...
			startRange 			: 0,
			limitRange 			: 10,
			tableName  			: 'OrderRejectReasonsMaster',			
		};
	}
...
export default OrderRejectReasons;