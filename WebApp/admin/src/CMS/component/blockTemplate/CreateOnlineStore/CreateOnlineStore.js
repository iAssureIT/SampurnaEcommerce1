...
export default class CreateOnlineStore extends Component{
    ...
    render(){
        return(
            <div className="container-fluid conlinewrapp" style={{backgroundImage:"url("+this.state.blocks.bgImage+")"}}>
                <div className="createonlinebgimg">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 bgwrappstore">
                        <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 Imgwrapp00">
							<img src={this.state.blocks.fgImage} className="ecomimgright" alt=""></img>
						</div>
						...
						<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 Imgwrapp000">
							<img src={this.state.fgImage1} className="ecomimgleft img-responsive"/>
						</div>
					</div>
				</div>
			</div>
