				...
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12" style={{backgroundImage:"url("+this.state.blocks.bgImage+")"}}>
					<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            <div className="">
                              	<img src={this.state.blocks.fgImage} alt="" className="intro_img"  width="350" />
                        	</div>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h1 className="lightbluetext para-top">{this.state.blocks.blockTitle}</h1>
                            <h3 className="lightbluetext para-top">{this.state.blocks.blockSubTitle}</h3>
                            <div> 
