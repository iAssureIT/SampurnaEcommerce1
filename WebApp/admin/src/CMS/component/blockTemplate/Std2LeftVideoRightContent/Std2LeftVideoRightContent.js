...
export default class Std2LeftVideoRightContent extends React.Component {
	constructor(props) {
	    super(props);
	    this.state = {
	      blocks: {
			...
			<div>	
				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12" style={{backgroundImage:"url("+this.state.blocks.bgImage+")"}}>
					<div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
						<video width="100%" height="30%" controls  className=""  src={this.state.blocks.fgVideo} type="video/mp4" alt="video" />
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
