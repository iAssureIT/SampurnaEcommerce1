...
const options = [
  { value: 'New', label: 'New', statusRank : 1},
  { value: 'Processing', label: 'Processing', statusRank : 2 },
  { value: 'Ready to Dispatch', label: 'Ready to Dispatch', statusRank : 3},
  { value: 'On the Way', label:'On the Way', statusRank : 4},
  { value: 'Delivered', label:'Delivered', statusRank : 5},
];
