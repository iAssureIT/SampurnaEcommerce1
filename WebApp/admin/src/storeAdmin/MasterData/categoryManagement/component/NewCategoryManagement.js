      ...
      .then((response)=>{
        ...
        var tableData = response.data.reverse().map((a, i)=>{                      
          return{ 
            ...
            subCategory           : "<a aria-hidden='true' class='actionInvoiceIcons' title='Show all SubCategories' id='" + a._id + "'data-toggle='modal' data-target='#subCategoryModal' onclick=window.openSubCategoryModal('"+ a._id + "')> SubCategories </a>",
            status                : a.status
          }
        })
        this.setState({
                        ...
                        <div className="row">
                         <div className="">
                            <div className="box-header with-border col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding-right">
                              ...
                              <div className="modal col-lg-12 col-md-12 col-sm-12 col-xs-12" id={"subCategoryModal"} aria-hidden="false" role="dialog">
				 	<div className="adminModal adminModal-dialog marginTopModal col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
						<div className="modal-content adminModal-content col-lg-12 col-md-12 col-sm-12 col-xs-12 noPadding">
							<div className="modal-header adminModal-header col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div className="col-lg-11 col-md-11 col-sm-11 col-xs-11 NOpadding-left NOpadding-right">
									<h4 className="invoicePaymentModalHeading">SubCategories of </h4>
								</div>
