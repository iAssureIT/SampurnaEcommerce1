...
class IAssureTable extends Component {
    ...
    showImageModal(event){
    	...
    	this.setState({productID:productId, productName:event.target.getAttribute('name').replace(/<br>/gi,', '),productNameRlang:event.target.getAttribute('namerlang')})
        ...
        return (
	       	<div id="tableComponent" className="col-lg-12 col-sm-12 col-md-12 col-xs-12 NoPadding">	
				...
				<div className="col-lg-6  col-md-6  col-xs-12 col-sm-12 text-center mt50">
					...
					<label className="col-lg-6 col-md-6 col-sm-12 col-xs-12">Selected Coupons: <span >{this.state.allid ? this.state.allid.length : '0'}</span> </label>
				</div> 
				{
													...
													<td className="textAlignCenter">
														...
														<div className="modal fade" id={"showDeleteModal-"+(value._id)} role="dialog">
	                                                        <div className=" adminModal adminModal-dialog col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                                          <div className="modal-content adminModal-content col-lg-4 col-md-6 col-md-offset-4 col-sm-10 col-sm-offset-1 col-xs-12 noPadding">
