            ...
            <div className="row">
              <div className="">
                ...
                <form id="CouponForm" className="">
	                ...
	                <div className="col-lg-4 fieldWrapper inputHeight60 noPadding">
	                    <div className="col-lg-12">
	                      <label>Max Discount<i className="redFont">*</i></label>
	                      <input value={this.state.maxdiscountvalue} name="maxdiscountvalue" id="maxdiscountvalue" maxLength="6"  onChange={this.handleChange.bind(this)} type="number" className="form-control edit-catg-new" placeholder="coupen Max Discount" ref="maxdiscountvalue" required/>
	                    </div>
	                </div>
