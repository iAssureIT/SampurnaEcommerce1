...
export default class DeliveryInitiatedOrders extends Component{
  ...
  render(){
    return(
      <div>
      <AdminOrdersList tableTitle={'Delivery Initiated Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} status="Delivery Initiated" getOrdersFun={this.getOrders}/>
      </div>
      );
