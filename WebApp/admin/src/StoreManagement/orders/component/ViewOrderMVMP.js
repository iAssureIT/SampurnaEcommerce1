            ...
            <br/>
              ...
              <div className="col-lg-11 col-md-12 col-sm-12 col-xs-12 outerbox">
                ...
                <div className="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                  ...
                  <div className="box-content">
                  {
                    this.state.orderData.paymentDetails
                  }
                  </div>
                </div>
                <div className="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                  ...
                  <div className="box-content"> 
                    <div>
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 NOpadding text-right"><span><i className={"fa fa-"+this.state.orderData.paymentDetails.currency}> {this.state.orderData.paymentDetails.netPayableAmount}</i></span> </div> 
                    </div>
                    <div>
                      <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 NOpadding"><span>Shipping:  </span></div>
                      <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 NOpadding text-right"><span><i className={"fa fa-"+this.state.orderData.paymentDetails.currency}> 0</i></span> </div>
                    </div>
                    ...
                    ? 
                        <div>
                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 NOpadding"><span>GST ({ this.state.companyInfo.taxSettings && this.state.companyInfo.taxSettings[0].taxRating} %):  </span></div>
                                ...
                                <span><i className={"fa fa-"+this.state.orderData.paymentDetails.currency}> { this.state.orderData.paymentDetails.taxAmount } </i></span> 
                            </div>
                        </div> 
                    : 
                        null
                    ...
                    <div>
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 NOpadding text-right">
                        ...
                        <span><i className={"fa fa-"+this.state.orderData.currency}> { parseInt(this.state.orderData.paymentDetails.netPayableAmount).toFixed(2) }</i></span>
                      </div>
                    </div>
                  </div>
                </div>
