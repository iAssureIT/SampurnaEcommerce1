				...
				<div className="modal-dialog modal-lg" role="document">
					<div className="modal-content modalContent col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
						<div className="modal-header adminModal-header col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<h4 className="CreateTempModal col-lg-8 col-md-8 col-sm-12 col-xs-12" id="exampleModalLabel">Create Template</h4>
							<div className="col-lg-4 col-md-4 col-sm-4 col-xs-12 NOpadding">
								<div className="col-lg-2 col-md-6 col-sm-12 col-xs-12 pull-right">
									<div className="adminCloseCircleDiv col-lg-6 col-md-6 col-sm-6 col-xs-12 NOpadding-left NOpadding-right">
