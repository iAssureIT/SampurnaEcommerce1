...
class ContactDetails extends Component {
	...
	componentDidMount() {
		...
		var pageUrl = window.location.pathname;;
	        ...
	        this.setState({
					      			...
					      			console.log("urlparam",this.state.urlparam)
					      		});
		var role = localStorage.getItem("roles");
		var Url= "";
			...
			const main = async()=>{
				if ($('#ContactDetail').valid()) {
					if(this.state.createUser === true && this.state.listOfEmpID.indexOf(this.state.employeeID) === -1){
						...
						var formValues1 = {
						userID: formValues.contactDetails.userID,
						role: this.state.urlParam == "Ba" ? "ba" : this.state.urlParam == "vendor" ? 'vendor' : 'franchise',
						}
	...
	updateContact = (formValues)=>{
		...
		.then((response) => {
			...
			this.props.history.push("/appCompany/contact-details/"+this.props.match.params.entityID);
			swal("Contact updated successfully.");
		})
		.catch((error) => {
			console.log("Error => ",error);
	...
	getDataTable(){
		...
		.then((response)=>{
	        ...
	        return{
				...
				CompanyBranch : a.branchName ? a.branchName : '-NA-',
				Department :  a.departmentName ? a.departmentName : '-NA-',
				Designation : a.designationName ? a.designationName : '-NA-',
							...
							<div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div className="nav-center OnboardingTabs col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<ul className="nav nav-pills vendorpills col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-3 col-sm-12 col-xs-12">
										...
										<li className={"active col-lg-4 col-md-3 col-sm-12 col-xs-12 transactionTab noRightPadding pdcls btn4 "+(this.state.entityID ? "" : "disabled")}>
											{/*<div className="trianglesix" id="triangle-right2"></div>*/}
											<a href={this.props.match.params.entityID ? "/"+this.props.entity+"/contact-details/"+this.props.match.params.entityID : "/"+this.props.entity+"/contact-details"} className="basic-info-pillss backcolor">
												<i className="fa fa-phone phoneIcon" aria-hidden="true"></i> &nbsp;
												Contact
												...
												<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
													<form id="ContactDetail" className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
														...
														<div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
															<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 "  >
																<label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12">Employee ID <i className="astrick">*</i></label>
																<input type="text" maxLength="10" id="employeeID" className="errorinputText form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.employeeID} ref="employeeID" name="employeeID" onChange={this.handleChange.bind(this)} />
															</div>
															<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 " >
																<label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12">First Name <sup className="astrick">*</sup></label>
																<input id="firstName" maxLength="128" type="text" className="errorinputText form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.firstName} ref="firstName" name="firstName" onChange={this.handleChange.bind(this)} required />
															</div>
															<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 " >
																<label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12">Last Name <sup className="astrick">*</sup></label>
																<input id="lastName" maxLength="128" type="text" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.lastName} ref="lastName" name="lastName" onChange={this.handleChange.bind(this)} required />
															</div>
														</div>
														<div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
															<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
