...
class BasicInfo extends Component {
  ...
  SubmitBasicInfo(event) {
	...
	//     companyPhoneAvailable : true
	//   },()=>{
	//     console.log("companyPhoneAvailable if")
	//   })
	// }
	// else{
	//    this.setState({
	...
	//   },()=>{
	//     console.log("companyPhoneAvailable false")
	//   })
	// }
	if(this.state.companyPhone){
		// this.setState({
        ...
        if (event.currentTarget.files && event.currentTarget.files[0]) {
            ...
            if(event.currentTarget.files){
                ...
                async function main(){
                    var config  = await getConfig();
                    console.log("config => ",config)
                    var s3url   = await s3upload(shopImage.fileInfo, config, this);
				...
				<div className="nav-center OnboardingTabs col-lg-12 col-md-12 col-sm-12 col-xs-12">
				  <ul className="nav nav-pills vendorpills col-lg-8 col-lg-offset-2 col-md-12  col-sm-12 col-xs-12">
					<li className={"active col-lg-4 col-md-3 col-sm-12 col-xs-12 pdcls pdclsOne btn1 NOpadding-left"}>
					  <a href={this.state.entityID ? "/"+this.props.entity+"/basic-details/"+this.state.entityID : "/"+this.props.entity+"/basic-details"} className="basic-info-pillss pills">
						<i className="fa fa-info-circle" aria-hidden="true"></i> &nbsp;
						Basic Info
					  </a>
					  {/*<div className="triangleone triangleones" id="triangle-right"></div>*/}
					</li>
					<li className={"col-lg-4 col-md-3 col-sm-12 col-xs-12 transactionTab pdcls pdclsOne btn2 disabledbackcolor" + (this.state.entityID ? "" : "disabled")}>
					  {/*<div className="triangletwo" id="triangle-right1"></div>*/}
					  <a href={this.state.entityID ? "/"+this.props.entity+"/location-details/"+this.state.entityID : "/"+this.props.entity+"/location-details" } className="basic-info-pillss backcolor">
					...
					<li className={"col-lg-4 col-md-3 col-sm-12 col-xs-12 transactionTab noRightPadding pdcls btn4 disabledbackcolor " + (this.state.entityID ? "" : "disabled")}>
					  ...
					  <a href={this.state.entityID ? "/"+this.props.entity+"/contact-details/"+this.state.entityID : "/"+this.props.entity+"/contact-details"} className="basic-info-pillss backcolor">
						...
						<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls">
						  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls NOpadding-left NOpadding-right">
							...
							<div className="col-lg-2 col-md-2 col-sm-12 col-xs-12 NOpadding">
								<label className="col-lg-12 col-md-12 col-sm-12 col-xs-12 imageLabel">Logo</label>
							  	<div className={ "col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding " + (this.state.companyLogo && this.state.companyLogo.length > 0 ? "hideDiv" : "")}>
									<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									  	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding " id="hide">
											<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 uploadImageClient" id="LogoImageUpOne" title="Upload Logo Image">
									  		...
									  		return (
												<div key={i} className="col-lg-12 col-md-12 col-sm-12 col-xs-12 CustomImageUploadBI">
										  			<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
														<label className="deletelogo col-lg-12 col-md-12 col-sm-12 col-xs-12" title="Delete Logo"  id={logo} onClick={this.deleteLogo.bind(this)}>x</label>
										...
										(this.state.gotImagecompanyLogo 
											?
												<div className={ "col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding " + (this.state.companyLogo && this.state.companyLogo.length > 0 ? "hideDiv" : "")}>
													<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													  	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding " id="hide">
															<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 uploadImageClient" id="LogoImageUpOne" title="Loading Logo Image">
							  	...
							  	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding ">
									<div className="col-lg-12 col-md-3 col-sm-12 col-xs-12">
				                        ...
				                        ?
				                            null
				                        :          
				                        	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 uploadImageClient" id="shopImageUpOne" title="Upload Shop Image">
										  		<div><i className="fa fa-image"></i></div>
										  		<input type="file" onChange={this.uploadShopImage.bind(this)} id="shopImageUp" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" title="" name="shopImage" />
											</div> 
				                        }
			                            {this.state.shopImage 
			                            ? 
			                            	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
												<label className="deletelogo col-lg-12 col-md-12 col-sm-12 col-xs-12" title="Delete Shop Image"  data-imageUrl={this.state.shopImage} onClick={this.deleteShopImage.bind(this)}>x</label>
												<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 uploadImageClient" id="LogoImageUpOne">
										  			<img src={this.state.shopImage ? this.state.shopImage : "/images/notavailable.jpg"} alt={"Shop Image"} className="img-responsive logoStyle" />
												</div>
								  			</div>			                                
			                            :
			                                null
											...
											{/*<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 uploadImageClient" id="shopImageUpOne" title="Upload shop Image">
									  			<div><i className="fa fa-image"></i></div>
									  			<input multiple onChange={this.imgBrowse.bind(this)} id="shopImageUp" type="file" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" title="" name="shopImage" />
											</div>*/}
								  		</div>
									</div>								
							  	</div>
