...
class CompanyTaxDetails extends Component{
   constructor(props) {
    ...
    this.state = {
      ...
      tableHeading      : {
        srNo          	: "Sr.No",
        taxType         : "Tax Type",
        taxRating       : "Tax Rating",
        effectiveFrom   : "Effective From"
      },
        tableObjects      : {
        deleteMethod    : 'delete',
        apiLink         : '/api/globalmaster/patch/status',
        paginationApply : false,
        searchApply     : false,
        editUrl         : '/globalmaster'
      },
  ...
  componentDidMount() {
    ...
    axios.get('/api/companysettings/getTaxData/'+userDetails.companyID)
    .then((response)=>{
      console.log("companyTaxData",response.data)
