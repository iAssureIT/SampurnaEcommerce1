        ...
        .then((response) => {
          ...
          this.setState(() => {
            if (companyName === "No Company Available") {
              ...
              // console.log('userid Post==>>>', "fname", this.state.firstname,"cname",this.state.companyName,"semail",this.state.signupEmail,"mobile",this.state.mobNumber);
              if (this.state.firstname !== "" && this.state.companyName !== "" && this.state.lastname !== "" && this.state.signupEmail && this.state.mobNumber ) {
                      ...
                      <form id="userInfo">
                        ...
                        <div className="valid_box">
                          ...
                          <div className="form-margin col-lg-6 col-md-6 col-xs-12 col-sm-12  valid_box">
                           ...
                           {/* <input type="number" max="10"  required pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890" className="formFloatingLabels form-control  newinputbox" ref="mobile" name="mobile" id="mobile" data-text="mobile" onChange={this.handleChange} value={this.state.mobile} /> */}
                          </div>
                        </div>
                        <div className="valid_box">
                          <div className="form-margin col-lg-6 col-md-6 col-xs-12 col-sm-12  valid_box " >
