...
export default class DispatchedOrdersList extends Component{
  ...
  render(){
    return(
      <div>
      <VendorOrdersList tableTitle={'Dispatched Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} showStatusFilter="false"  status="Dispatch" getOrdersFun={this.getOrders}/>
      </div>
      );
