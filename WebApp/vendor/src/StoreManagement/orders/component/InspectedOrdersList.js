...
export default class InspectedOrdersList extends Component{
  ...
  render(){
    return(
      <div>
      <VendorOrdersList tableTitle={'Inspected Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} showStatusFilter="false" status="Inspection" getOrdersFun={this.getOrders}/>
      </div>
      );
