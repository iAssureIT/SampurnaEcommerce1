...
export default class DeliveredOrders extends Component{
  ...
  render(){
    return(
      <div>
        <VendorOrdersList tableTitle={'Delivered & Paid Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} status="Delivered & Paid" getOrdersFun={this.getOrders}/>
      </div>
      );
