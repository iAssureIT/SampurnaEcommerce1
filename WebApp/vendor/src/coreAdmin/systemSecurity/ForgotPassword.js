  ...
  render(){
    ...
    return(
      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 signUpWrapper">
        <div className="col-lg-4 col-lg-offset-7 col-md-4 col-md-offset-7 col-sm-12  signupPadding  bg-success loginFormWrap" >
          <div className="divForgotPasswordWrap">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12  verifypd">
              <h3 className="forgretTitle"><span className="bordbt">Forgot Password</span> </h3>
              <div className="FormWrapper col-lg-12 col-md-12 col-sm-12 col-xs-12 forPassWrap">
                <form id="forgotPassword" onSubmit={this.forgotpassword.bind(this)}>
                  <div className="text-left col-lg-12 col-md-12 col-sm-12 col-xs-12 otpHeader">
                    <span>Email ID<label className="astricsign">*</label> </span>
                  </div>
                  ...
                  <div className="submitButtonWrapper col-lg-12 col-md-12 col-sm-12 col-xs-12 pdleftclr">
                    <Link to='/confirm-otp'>
                      <button type="submit" className="btn col-lg-12 col-md-12 col-sm-12 col-xs-12 submitBtn UMloginbutton">Send OTP</button>
                    </Link>
                  </div>
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls">
                    <Link to='/' className="UMGrey UMGreyy_l UMcreateacc forgot  col-lg-12 col-md-12 col-sm-12 col-xs-12">Sign In</Link>   
                  </div>
                </form>
              </div>
            </div>
