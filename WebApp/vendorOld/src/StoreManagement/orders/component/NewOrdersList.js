...
export default class NewOrdersList extends Component{
  ...
  render(){
    return(
      <div>
      <VendorOrdersList tableTitle={'New Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} showStatusFilter="false" status="New Order" getOrdersFun={this.getOrders}/>
      </div>
      );
