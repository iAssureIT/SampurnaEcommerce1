...
export default class ApprovedOrdersList extends Component{
  ...
  render(){
    return(
      <div>
      <VendorOrdersList tableTitle={'Approved Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} showStatusFilter="false" status="Dispatch Approved" getOrdersFun={this.getOrders}/>
      </div>
      );
