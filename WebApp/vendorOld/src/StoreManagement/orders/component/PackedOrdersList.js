...
export default class PackedOrdersList extends Component{
  ...
  render(){
    return(
      <div>
      <VendorOrdersList tableTitle={'Packed Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} showStatusFilter="false" status="Packed" getOrdersFun={this.getOrders}/>
      </div>
      );
