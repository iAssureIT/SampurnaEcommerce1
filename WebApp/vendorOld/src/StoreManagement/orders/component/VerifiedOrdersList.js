...
export default class VerifiedOrdersList extends Component{
  ...
  render(){
    return(
      <div>
      <VendorOrdersList tableTitle={'Verified Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} showStatusFilter="false"  status="Verified" getOrdersFun={this.getOrders}/>
      </div>
      );
