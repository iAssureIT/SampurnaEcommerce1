                              ...
                              <View style={[styles.flx1, styles.prdet]}>
                                <View style={[styles.flxdir]}>
                                  <Icon
                                    ...
                                    size={13}
                                    color="#333"
                                    iconStyle={{ marginTop: 6, marginRight: 3 }}
                                  />
                                  {/* <Text style={styles.ogprice}>{item.originalPrice} - <Text style={styles.packofnos}>{item.size} {item.unit}</Text> </Text> */}
                                  {
                                      item.discountPercent > 0 ?
                                        ...
                                        :
                                        <Text style={styles.ogprice}>{item.originalPrice}  <Text style={styles.packofnos}>- {item.size} {item.unit != 'Number' ? item.unit : ''}</Text> </Text>
                                    }
                                </View>
                              </View>
