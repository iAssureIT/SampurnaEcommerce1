...
const rewardPointsRoutes					= require("./api/Ecommerce/RewardPoints/Routes");
const rewardPointsPolicyRoutes				= require("./api/Ecommerce/RewardPointsPolicy/Routes");
...
app.use("/api/rewardpointspolicy", 			rewardPointsPolicyRoutes);
